...
const Energia = () => {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center h-screen">
        <div className="text-xl animate-pulse">Carregando dados de Energia...</div>
      </div>
    );
  }
    ...
    return (
      <div className="container mx-auto p-6 space-y-8">
         <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
               <h1 className="text-3xl font-bold text-gray-900">Energia Elétrica</h1>
               <p className="text-gray-500 mt-1">Análise de aquisições de energia elétrica e gás</p>
            </div>
         </div>
         <div className="text-center py-20 bg-gray-50 rounded-lg border border-dashed border-gray-300">
            <h2 className="text-xl font-semibold text-gray-700">Nenhum registro de Energia (C500) encontrado</h2>
            <p className="text-gray-500 mt-2">O banco de dados não possui registros C500.</p>
  ...
  const handleExport = () => {
    ...
    exportToExcel(exportData, 'relatorio_energia');
  };
  ...
  return (
    <div className="container mx-auto p-6 space-y-8">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Energia Elétrica</h1>
          <p className="text-gray-500 mt-1">Análise de aquisições de energia elétrica e gás (C500)</p>
        </div>
